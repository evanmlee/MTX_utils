...
kallisto_data_utils.py: Functions for processing kallisto and bowtie2 outputs into counts tables, loading and summary metric calculations on counts tables, formatting method input for differential expression tools, and some general visualization plot functions (volcano plots, bar-swarm plots, etc)
